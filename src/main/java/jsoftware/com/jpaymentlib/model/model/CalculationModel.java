...
public interface CalculationModel {
    ...
    /**
     * Ejecuta la operación aritmética correspondiente al modelo sobre los
     ...
     */
    BigDecimal getTotal(BigDecimal base, BigDecimal amount);

    /**
     * Define si la regla de cálculo debe aplicarse o ignorarse en la
     * transacción.
     *
     * @param apply Cadena de texto que activa ("1") o desactiva ("0") la
     * aplicación.
     */
